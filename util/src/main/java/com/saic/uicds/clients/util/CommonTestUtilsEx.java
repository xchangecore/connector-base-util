...
public class CommonTestUtilsEx {

    public static final String DEFAULT_ORG_PRINCIPAL_OFFICAL_NAME = "LiTest";

    public static final String DEFAULT_ORG_PRINCIPAL_PHONE = "666-6666";

    public static final String DEFAULT_LONGITUDE = "67.0";

    public static final String DEFAULT_LATITIDUE = "41.0";

    public static final String DEFAULT_INCIDENT_ADDRESS = "223 Main St.";
    ...
    public static final String IG_ID1 = "IG-M0154127-f198-402d-a1bf-721a066f497f";
    ...
    //new board specific data
    public static final String DEFAULT_RECORD_DATE = "2010-02-24T08:05:00";

    public static final String DEFAULT_CONTACT_NAME = "John Roger";

    public static final String DEFAULT_CONTACT_PHONE = "703-222-3344";
    ...
    public static WorkProduct getClosedWorkProduct(WorkProduct workProduct) {
        ...
        DigestType digest = createDefaultIncidentDigest();
        WorkProduct closedProduct = CommonTestUtilsEx.getIncidentWorkProduct(wpid, props, digest,
            incident);
    ...
    public static DigestType createDefaultIncidentDigest() {
        ...
        CommonTestUtilsEx.setEvent(digest, EVENT_ID1, DEFAULT_ACTIVITY_DESCRIPTION,
    ...
    public static IncidentDocument getDefaultIncident() {
        ...
        incident.getIncident().addNewActivityReasonText().setStringValue("LiTest1");
        incident.getIncident().getActivityReasonTextArray(0).setStringValue(DEFAULT_CONTACT_NAME);
        incident.getIncident().addNewActivityReasonText().setStringValue("LiTest2");
        incident.getIncident().getActivityReasonTextArray(1).setStringValue(DEFAULT_CONTACT_PHONE);
    //    incident.getIncident().addNewActivityReasonText().setStringValue("LiTest3");
    //    incident.getIncident().getActivityReasonTextArray(2).setStringValue(DEFAULT_RECORD_DATE);
        
        incident.getIncident().addNewActivityDateRepresentation().newCursor();
        incident.getIncident().getActivityDateRepresentationArray(0).newCursor().setTextValue(DEFAULT_RECORD_DATE);
    ...
    public static GetAssociatedWorkProductListResponseDocument createAssociatedWorkProductListResponse() {
        ...
        WorkProduct incidentWorkProduct = CommonTestUtilsEx.getDefaultIncidentWorkProduct();
